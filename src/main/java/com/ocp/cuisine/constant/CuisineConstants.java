package com.ocp.cuisine.constant;
...
public class CuisineConstants {
    ...
    public static final String ID_NOT_EXIST = "User ID does not exist";
    public static final String INCORRECT_OLD_PASSWORD = "Incorrect old password";
    public static final String PASSWORD_UPDATE = "Password Update Successfully";
    public static final String CREDENTIALS = "Credentials by Cafe Management";
    public static final String CREDENTIALS_EMAIL = "Check your Email for credentials";
